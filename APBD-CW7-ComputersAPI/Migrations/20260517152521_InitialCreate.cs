    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ASUS", new DateTime(1989, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "ASUS Corporation" },
                    { 2, "MSI", new DateTime(1986, 8, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "MSI Corporation" },
                    { 3, "INTEL", new DateTime(1968, 7, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Intel Corporation" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2026, 3, 1, 10, 15, 0, 0, DateTimeKind.Unspecified), "Streamer Ultra", 3, 48, 9.8000000000000007 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU001", 3, 1, "High-end gaming processor", "Intel Core i9" },
                    { "GPU001", 2, 2, "Gaming graphics card", "MSI RTX 4080" },
                    { "RAM001", 1, 3, "DDR5 RAM memory", "ASUS DDR5 32GB" }
                });
